 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'mynameisahmedkhaledandiamthedeployer');
/**
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/aa-ahmed-aa/spebok');
/**
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/var/www/spebok/');
/**
 ...
 * @var boolean
 */
if (!defined('DELETE_FILES')) define('DELETE_FILES', true);
/**
